...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT * FROM admins WHERE username = '$username' OR email = '$email' LIMIT 1";
    ...
    if (empty($errors)) {
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Registration successful!'); window.location.href='manage_adminaccs.php';</script>";
        } else {
...
<head>
    ...
    <title>Create Admin Account - MViTour</title>
...
<body>
    ...
    <!-- Back Button -->
    <a href="manage_adminaccs.php" class="back-btn">
