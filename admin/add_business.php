...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO businesses (name, description, location, barangay, category, latitude, longitude, budget, images, destination_thumbnail, opening_time, closing_time, is_open) 
            VALUES ('$name', '$description', '$location', '$barangay', '$category', '$latitude', '$longitude', '$budget', '$images', '$thumbnailImage', '$opening_time', '$closing_time', $is_open)";
...
<head>
    <meta charset="UTF-8">
    <title>Add Business - MViTour</title>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="category-grid">
                            <div class="category-option" data-value="Restaurant">
                                <i class="fas fa-utensils"></i>
                                <span>Restaurant</span>
                            </div>
                            <div class="category-option" data-value="Transient House">
                                <i class="fas fa-house"></i>
                                <span>Transient House</span>
                            </div>
                            <div class="category-option" data-value="Hotel">
                                <i class="fas fa-hotel"></i>
                                <span>Hotel</span>
                            </div>
                            <div class="category-option" data-value="Inn">
                                <i class="fas fa-bed"></i>
                                <span>Inn</span>
                            </div>
                            <div class="category-option" data-value="Resort">
                                <i class="fas fa-umbrella-beach"></i>
                                <span>Resort</span>
                            </div>
                            <div class="category-option" data-value="Apartelle">
