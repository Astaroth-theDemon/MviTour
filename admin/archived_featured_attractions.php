...
// Fetch all archived featured attractions
$sql = "SELECT * FROM featured_attractions WHERE status = 'archived'";
...
function getCategoryIcon($category) {
    switch ($category) {
        ...
        case 'Festivals & Events': return 'fa-calendar-day';
...
<head>
    <meta charset="UTF-8">
    <title>Archived Featured Attractions - MViTour</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="breadcrumb">
            ...
            <i class="fas fa-chevron-right"></i>
            <span>Archived Featured Attractions</span>
        </div>
        ...
        <div class="destinations-grid">
                ...
                <div class="destination-card">
                    ...
                    <div class="destination-content">
                        ...
                        <div class="action-buttons">
                            ...
                            <button class="unarchive-btn" onclick="confirmUnarchive(<?php echo $row['attraction_id']; ?>)">
            ...
            <?php 
                ...
                <div style="grid-column: 1 / -1; text-align: center; padding: 40px;">
                    <i class="fas fa-archive" style="font-size: 3rem; color: #6c757d; margin-bottom: 15px;"></i>
                    <p>No archived featured attractions found.</p>
                </div>
                <?php
            } 
            ?>
    ...
    <script>
        ...
        function confirmUnarchive(id) {
            showConfirmModal("Are you sure you want to unarchive this featured attraction?", (confirmed) => {
                if (confirmed) {
                    window.location.href = `unarchive_featured_attraction.php?id=${id}`;
                }
            });
        }
    </script>
