...
<head>
    <meta charset="UTF-8">
    <title>Manage Businesses - MViTour</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="top-actions">
            <a href="archived_businesses.php" class="view-archived-btn">
                <i class="fas fa-archive"></i>
                View Archived Businesses
            </a>
        </div>
        ...
        <div class="filter-section">
            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="Search for businesses, categories, or locations...">
            </div>
                ...
                <div class="business-card" 
                    ...
                    <div class="business-content">
                        ...
                        <div class="action-buttons">
                            ...
                            <button class="archive-btn" onclick="confirmArchive(<?php echo $row['business_id']; ?>)">
    ...
    <script>
        ...
        function confirmArchive(id) {
            showConfirmModal("Are you sure you want to archive this business?", (confirmed) => {
                if (confirmed) {
                    window.location.href = `archive_business.php?id=${id}`;
                }
            });
        }
        ...
        let businessCards = Array.from(document.querySelectorAll('.business-card'));
        ...
        function updateBusinesses() {
            ...
            // Filter businesses
            let filteredBusinesses = businessCards.filter(card => {
            ...
            filteredBusinesses.sort((a, b) => {
                switch(sortBy) {
                    ...
                    case 'price-low':
                        return parseFloat(a.getAttribute('data-budget')) - parseFloat(b.getAttribute('data-budget'));
                    case 'price-high':
                        return parseFloat(b.getAttribute('data-budget')) - parseFloat(a.getAttribute('data-budget'));
                    default:
                        return 0;
                }
            });
            ...
            if (filteredBusinesses.length > 0) {
                filteredBusinesses.forEach(card => businessesGrid.appendChild(card));
            } else {
                businessesGrid.innerHTML = '<p>No businesses found matching your criteria.</p>';
            }
        }

        // Event listeners
        searchInput.addEventListener('input', updateBusinesses);
        categoryFilter.addEventListener('change', updateBusinesses);
        locationFilter.addEventListener('change', updateBusinesses);
        sortBySelect.addEventListener('change', updateBusinesses);
